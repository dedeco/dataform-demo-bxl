...
## 🏗️ Arquitectura de Capas de Datos

El pipeline de datos sigue un enfoque de buenas prácticas con arquitectura de tres capas (Raw ➡️ Staging ➡️ Trusted) utilizando un conjunto de datos público de StackOverflow como origen.
...
## ⚙️ Configuración del Proyecto (`workflow_settings.yaml`)
...
## 🛠️ Detalle de las Capas y Modelos
...
## 🏷️ Orquestación por Etiquetas (`Tags`)
